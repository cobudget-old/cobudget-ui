...
### @ngInject ###
module.exports = ($scope, $state, config, AuthService, AllocationModel, AllocationsStore, group, round, memberships) ->
  ...
  $scope.onError = (response) ->
    ...
    # TODO send error to default error modal
